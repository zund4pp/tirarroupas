...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('Colocar as roupas'), value = 'ubie'})
	table.insert(elements, {label = ('Retirar camisola'), value = 'tul'})
	table.insert(elements, {label = ('Retirar calças'), value = 'spo'})
	table.insert(elements, {label = ('Retirar sapatos'), value = 'but'})
	table.insert(elements, {label = ('Fechar'), value = 'fechar'})
